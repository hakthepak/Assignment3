...
module.exports = class extends Page {
    ...
    render(sPage) {
        const oJson = fetch("https://ux308assignment3-default-rtdb.firebaseio.com/meals.json").json();
        console.log(oJson);
        ...
        Object.keys(oJson).map((key) => {
            ...
            <form action="https://payment-assignment-3.herokuapp.com/payment/" method="post">
